...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'acohen49', 'email': 'acohen49@umd.edu', 'first_name': 'Alexander', 'last_name': 'Cohen',
         'password': generate_password_hash('acohen49', method='pbkdf2:sha256'), 'role': 'STUDENT'}, #Added myself as a user
